-- Insert the data of orders_payment according to the table below.
-- Note: The total amount should be calculated from all service tables (online_washdry, ironing, delivery), except failed payment.
